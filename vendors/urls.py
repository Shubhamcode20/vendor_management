...
urlpatterns = [
    ...
    path('api/purchase_orders/<int:purchase_order_id>/', views.PurchaseOrderApi.as_view()),
    path('api/purchase_orders/<int:purchase_order_id>/acknowledge/', views.PurchaseOrderAcknowledgeApi.as_view())
]
